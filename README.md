...
🔧 Yapılan İşlemler
Konteynerleştirme: Uygulama servisleri Docker imajları olarak yapılandırıldı ve IBM Cloud Container Registry'ye yüklendi.

Dağıtım (Deployment): IBM Cloud Code Engine kullanılarak mikroservisler canlıya alındı.

Entegrasyon: Frontend tarafındaki index.html dosyası, canlıdaki mikroservislerin API uç noktalarıyla (endpoints) haberleşecek şekilde güncellendi.

Versiyon Kontrolü: Tüm süreç Git üzerinden yönetilerek GitHub portföyüne aktarıldı.
